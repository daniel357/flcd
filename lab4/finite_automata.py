def parse_automaton_data(file_name="FA.txt"):
    ...
    with open(file_name) as file:
        ...
        for line in file:
            ...
            value = clean_line[1]
            destination_state = clean_line.strip().split('=>')[1].strip()

            # Storing transitions in a dictionary
            if (source_state, value) in transitions.keys():
                transitions[(source_state, value)].append(destination_state)
            else:
                transitions[(source_state, value)] = [destination_state]
        ...
        print(states, initial_state, final_states, transitions, alphabet)
